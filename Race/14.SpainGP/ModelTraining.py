...
columns = [
       ...
       'FP3_DeltaToFastest', 'LapTime_Rank', 'StartXConst', 'DriXConst', 'FP3XStart'
       ]
...
plt.tight_layout()
plt.savefig(f"{File_Path}Plots/Feature_importance{corr:.2f}.png", dpi=300, bbox_inches='tight')
