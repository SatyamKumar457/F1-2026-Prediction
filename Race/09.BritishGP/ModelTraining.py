...
TRA = pd.read_csv("Race/09.BritishGP/Data/TrainingData.csv")
...
plt.tight_layout()
plt.savefig("Race/09.BritishGP/Plots/Feature_importance_in_2nd_itration.png", dpi=300, bbox_inches='tight')
