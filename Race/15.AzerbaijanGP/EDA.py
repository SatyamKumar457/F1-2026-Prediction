...
NED = pd.read_csv(f"{File_Path}Data/NetherlandsGP.csv")
ITL = pd.read_csv(f"{File_Path}Data/ItalyGP.csv")
SPA = pd.read_csv(f"{File_Path}Data/SpainGP.csv")

TRA = pd.concat([AUS,CHI,JAP,MIA,CAN,MON,BAR,AUA,BRI,BEL,HUN,NED,ITL,SPA],axis=0)
...
BRI.dropna(subset=['Qualifying_Time(s)','Race_Result'],inplace=True)
...
NED.dropna(subset=['Qualifying_Time(s)','Race_Result'],inplace=True)
NED['FP1_BestTime(s)'].fillna(NED['FP1_BestTime(s)'].median(),inplace=True)
NED['FP2_BestTime(s)'].fillna(NED['FP2_BestTime(s)'].median(),inplace=True)
NED['FP3_BestTime(s)'].fillna(NED['FP3_BestTime(s)'].median(),inplace=True)
NED['Sector1Time(s)'].fillna(NED['Sector1Time(s)'].median(),inplace=True)
NED['Sector2Time(s)'].fillna(NED['Sector2Time(s)'].median(),inplace=True)
NED['Sector3Time(s)'].fillna(NED['Sector3Time(s)'].median(),inplace=True)
NED['Average_Laptime(s)'].fillna(NED['Average_Laptime(s)'].mean(),inplace=True)
NED['AveragePointsFromLast3Races'].fillna(0,inplace=True)

print("Data Cleaning Done")

NED=NED.sort_values('FP1_BestTime(s)', ascending=True).reset_index(drop=True)
NED['FP1_Rank'] = NED.index+1
NED=NED.sort_values('FP2_BestTime(s)', ascending=True).reset_index(drop=True)
NED['FP2_Rank'] = NED.index+1
NED=NED.sort_values('FP3_BestTime(s)', ascending=True).reset_index(drop=True)
NED['FP3_Rank'] = NED.index+1

NED['FP1_DeltaToFastest'] = NED['FP1_BestTime(s)'] - NED['FP1_BestTime(s)'].min()
NED['FP2_DeltaToFastest'] = NED['FP2_BestTime(s)'] - NED['FP2_BestTime(s)'].min()
NED['FP3_DeltaToFastest'] = NED['FP3_BestTime(s)'] - NED['FP3_BestTime(s)'].min()

NED=NED.sort_values('Sector1Time(s)', ascending=True).reset_index(drop=True)
NED['Sector1_Rank'] = NED.index+1
NED=NED.sort_values('Sector2Time(s)', ascending=True).reset_index(drop=True)
NED['Sector2_Rank'] = NED.index+1
NED=NED.sort_values('Sector3Time(s)', ascending=True).reset_index(drop=True)
NED['Sector3_Rank'] = NED.index+1

NED['CombinedSectorTime'] = NED['Sector1Time(s)']+NED['Sector2Time(s)']+NED['Sector3Time(s)']
NED['CombinedSectorDelta'] = NED['CombinedSectorTime']-NED['CombinedSectorTime'].min()

NED=NED.sort_values('Average_Laptime(s)', ascending=True).reset_index(drop=True)
NED['LapTime_Rank'] = NED.index+1

NED['DeltaToFastestLap'] = NED['Average_Laptime(s)'] - NED['Average_Laptime(s)'].min()

NED['StartXConst'] = NED['Starting_Pos']*NED['ConstructorPoints']
NED['DriXConst'] = NED['DriverPoints']*NED['ConstructorPoints']
NED['FP3XStart'] = NED['FP3_Rank']*NED['Starting_Pos']


NED = NED.sort_values('Driver', ascending=True).reset_index(drop=True)




ITL.dropna(subset=['Qualifying_Time(s)','Race_Result'],inplace=True)
ITL['FP1_BestTime(s)'].fillna(ITL['FP1_BestTime(s)'].median(),inplace=True)
ITL['FP2_BestTime(s)'].fillna(ITL['FP2_BestTime(s)'].median(),inplace=True)
ITL['FP3_BestTime(s)'].fillna(ITL['FP3_BestTime(s)'].median(),inplace=True)
ITL['Sector1Time(s)'].fillna(ITL['Sector1Time(s)'].median(),inplace=True)
ITL['Sector2Time(s)'].fillna(ITL['Sector2Time(s)'].median(),inplace=True)
ITL['Sector3Time(s)'].fillna(ITL['Sector3Time(s)'].median(),inplace=True)
ITL['Average_Laptime(s)'].fillna(ITL['Average_Laptime(s)'].mean(),inplace=True)
ITL['AveragePointsFromLast3Races'].fillna(0,inplace=True)

print("Data Cleaning Done")

ITL=ITL.sort_values('FP1_BestTime(s)', ascending=True).reset_index(drop=True)
ITL['FP1_Rank'] = ITL.index+1
ITL=ITL.sort_values('FP2_BestTime(s)', ascending=True).reset_index(drop=True)
ITL['FP2_Rank'] = ITL.index+1
ITL=ITL.sort_values('FP3_BestTime(s)', ascending=True).reset_index(drop=True)
ITL['FP3_Rank'] = ITL.index+1

ITL['FP1_DeltaToFastest'] = ITL['FP1_BestTime(s)'] - ITL['FP1_BestTime(s)'].min()
ITL['FP2_DeltaToFastest'] = ITL['FP2_BestTime(s)'] - ITL['FP2_BestTime(s)'].min()
ITL['FP3_DeltaToFastest'] = ITL['FP3_BestTime(s)'] - ITL['FP3_BestTime(s)'].min()

ITL=ITL.sort_values('Sector1Time(s)', ascending=True).reset_index(drop=True)
ITL['Sector1_Rank'] = ITL.index+1
ITL=ITL.sort_values('Sector2Time(s)', ascending=True).reset_index(drop=True)
ITL['Sector2_Rank'] = ITL.index+1
ITL=ITL.sort_values('Sector3Time(s)', ascending=True).reset_index(drop=True)
ITL['Sector3_Rank'] = ITL.index+1

ITL['CombinedSectorTime'] = ITL['Sector1Time(s)']+ITL['Sector2Time(s)']+ITL['Sector3Time(s)']
ITL['CombinedSectorDelta'] = ITL['CombinedSectorTime']-ITL['CombinedSectorTime'].min()

ITL=ITL.sort_values('Average_Laptime(s)', ascending=True).reset_index(drop=True)
ITL['LapTime_Rank'] = ITL.index+1

ITL['DeltaToFastestLap'] = ITL['Average_Laptime(s)'] - ITL['Average_Laptime(s)'].min()

ITL['StartXConst'] = ITL['Starting_Pos']*ITL['ConstructorPoints']
ITL['DriXConst'] = ITL['DriverPoints']*ITL['ConstructorPoints']
ITL['FP3XStart'] = ITL['FP3_Rank']*ITL['Starting_Pos']


ITL = ITL.sort_values('Driver', ascending=True).reset_index(drop=True)



SPA.dropna(subset=['Qualifying_Time(s)','Race_Result'],inplace=True)
